...
//REG_TM3CNT_H=0;
//delay_10cycles();
__asm("NOP");//some nop instructions to delay cpu cycles for i2c bus,1 cycle is about 60ns,7 cycles will be 0.4us (400khz).
__asm("NOP");
__asm("NOP");
__asm("NOP");
__asm("NOP");
...
while(REG_TM3CNT_L<(65*us));//65*256*60ns=0.99ms
...
REG_TM3CNT_L=0;//clear timer3 for next time
while(REG_TM3CNT_L<(18*ms));//18*1*60ns=1000ns
REG_TM3CNT_H=0;//close timer3
}
